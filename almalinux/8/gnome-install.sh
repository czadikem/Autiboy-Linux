...
sleep 5
wget https://raw.githubusercontent.com/czadikem/autiboys-linux/master/almalinux/8/almalinux8-gnome-configure.sh -P /home/autiboy/ -O almalinux8-configure.sh
